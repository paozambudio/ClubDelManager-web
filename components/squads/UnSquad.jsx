...
const steps = [
  ...
  {
    label: "Contenidos e I+D",
    lead: "Andy García / Pablo Iacobucci",
    type: "Formación",
    description:
      "En este espacio buscaremos que personas de similares intereses y áreas de expertise puedan desarrollar ideas para compartir a la comunidad del Club y a la sociedad. Estaremos divididos en áreas de acuerdo al negocio: Vino - Gastronomía, Turismo, Hotelería y servicios - Comercio - Industria - Servicios. El objetivo es que podamos compartir mejores prácticas en cada uno de estos nichos de negocio, con foco en el rol del líder. Esta es una propuesta en donde buscamos que los Managers puedan volcar toda su experiencia profesional y laboral en pastillas de formación dirigida a managers y directivos en general. Actualmente contamos con el apoyo de varias universidades y te necesitamos para diseñar los programas como disctrlos. Esperamos que te sumes y seas parte del team!",
  },
  {
