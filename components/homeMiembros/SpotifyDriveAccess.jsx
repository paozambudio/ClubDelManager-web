          ...
          <div className="w-full max-w-sm px-4 py-3 m-10 bg-gradient-to-r from-slate-200 to-slate-300 rounded-md shadow-md">
            ...
            <div className="px-4 py-4">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Accede a nuestra biblioteca de libros y contenidos, además de
                podcasts exclusivos en Spotify.
              </p>
            </div>
            <div className="px-4 py-2 border-t border-gray-300">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Accede a todos los libros y contenidos disponibles para los
                miembros del Club del Manager. ¡Siéntete libre de hacer todos
                los aportes que quieras!
              </p>
            </div>
