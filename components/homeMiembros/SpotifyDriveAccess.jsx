...
export default function SpotifyDriveAccess() {
  ...
  return (
    <div className="flex flex-wrap justify-center">
      <div className="max-w-sm overflow-hidden bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg shadow-lg  m-10">
        {session && (
          ...
          <div className="px-4 py-2">
            <div class="flex items-center">
              <div className="flex items-center w-full px-4 py-2 rounded-lg bg-sky-600">
                <Link
                  className="flex items-center px-2 py-1 text-xs w-full font-semibold text-sky-700 uppercase transition-colors duration-300 transform bg-slate-200 rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none"
      ...
      <div className="max-w-sm overflow-hidden bg-gradient-to-r from-slate-200 to-slate-300 rounded-lg shadow-lg  m-10">
        {session && (
          <div className="px-4 py-2">
            <h1 className="text-xl font-bold text-gray-800 uppercase dark:text-gray-800">
              NUESTROS PODCASTS
            </h1>
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-600">
        ...
        {session && (
          <div className="px-4 py-2">
            <div className="flex items-center w-full px-4 py-2 rounded-lg bg-teal-600">
              <Link
                className="flex items-center px-2 py-1 text-xs w-full font-semibold text-teal-700 uppercase transition-colors duration-300 transform bg-slate-200 rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none"
